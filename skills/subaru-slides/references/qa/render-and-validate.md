...
## Validate
- Structural: for this repository's own decks, `python3 tools/pptx_inspect.py deck.pptx` reports slides, charts, tables, images, text, fonts, placeholders.
...
- `python3 tools/pptx_inspect.py deck.pptx` - raw structural metrics.
