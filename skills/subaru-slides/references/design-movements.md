...
> 基于本 skill 的默认审美偏好整理。用于风格讨论时建立共同语言——当我们说「田中一光风格」或「瑞士国际主义」时，双方都知道在说什么。
>
...
**代表**：Gumroad、Figma 社区与当代品牌演示
**视觉特征**：粗黑边框(3-6px)、高饱和色块、无渐变、偏移阴影、大字排版
**配色**：高对比原色——红黄黑米白是典型组合
**适合PPT**：非常适合。信息层次清晰，远距离可读性强
**与 skill 的关系**：适合 HTML→PPTX 路径；使用本地项目样例进行验证。
...
**为什么参考**：大胆色彩和几何构成可以探索视觉主题，并与本 skill 的默认审美偏好高度重合
...
**为什么参考**：「数据人文主义」理念和本 skill 的温暖叙事偏好完全对应
...
*整理于 2026-02-09 | 基于本 skill 的默认审美偏好*
